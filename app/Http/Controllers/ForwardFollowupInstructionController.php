...
class ForwardFollowupInstructionController extends Controller
{
    ...
    public function __construct(
        ...
        $this->middleware('permission:showform.forward-followup-instruction')->only('showform');
        $this->middleware('permission:submit.forward-followup-instruction')->only('submit');
    }
