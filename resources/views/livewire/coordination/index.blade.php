                ...
                @forelse($coordinations as $index => $coordination)
                    <tr>
                        ...
                        @if ($messageType == 'received' || $messageType == 'all')
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                <span
                                    class="px-2 py-1 bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-100 rounded-full text-xs">{{ $coordination->sender->name }}</span>
                            </td>
                        @endif
                        ...
                        <!-- Diteruskan Oleh -->
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                            @if ($coordination->forwards->isNotEmpty())
                                @foreach ($coordination->forwards->unique('forwarded_by') as $forward)
                                    <span
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                            @if ($coordination->forwards->isNotEmpty())
                                @foreach ($coordination->forwards as $forward)
                                    <span
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                            {{ \Carbon\Carbon::parse($coordination->start_time)->format('d-m-Y') }}</td>

                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                            {{ \Carbon\Carbon::parse($coordination->end_time)->format('d-m-Y') }}</td>
