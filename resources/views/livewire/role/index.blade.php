        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
            ...
            <div>
                ...
                <p class="text-gray-700 dark:text-gray-300 text-base md:text-lg">
                    Kelola role di <span class="font-semibold">Koridor</span>.
                </p>
            </div>
            ...
            <div class="flex flex-col items-end gap-2">
                ...
                <form method="GET" action="{{ route('roles.index') }}" class="w-full sm:w-64">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Nama Role</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Permission</th>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($roles as $index => $role)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $role->name }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $role->name }}</td>
