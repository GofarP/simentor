<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-12 w-full mx-auto bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-8 w-full">
            <h2 class="text-2xl font-bold text-violet-600 mb-6">Detail Tindak Lanjut Koordinasi</h2>

            {{-- Koordinasi --}}
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-medium mb-2">Koordinasi</label>
            ...
            <div class="mb-4">
                ...
                <input id="description" type="hidden" value="{{ $followupcoordination->description }}">
