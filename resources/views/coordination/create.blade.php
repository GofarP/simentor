        ...
        <div  class="bg-white dark:bg-gray-800 rounded-2xl shadow p-8 w-full">
            ...
            <form method="POST" action="{{ route('coordination.store',['messageType' => request('messageType')]) }}" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm
                               focus:ring-2 focus:ring-violet-500 focus:border-violet-500
                               dark:bg-gray-800 dark:text-gray-200" required placeholder="Masukkan title">
                    @error('title')
                        <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="start_time" id="waktu_mulai" value="{{ old('start_time') }}" class="form-input w-full rounded border-gray-300 dark:border-gray-600
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="end_time" id="end_time" value="{{ old('end_time') }}" class="form-input w-full rounded border-gray-300 dark:border-gray-600
                               dark:bg-gray-700 dark:text-gray-200"  min="{{ date('Y-m-d') }}">
                    @error('end_time')
                        <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="attachment" id="attachment" class="form-input w-full rounded border-gray-300 dark:border-gray-600
